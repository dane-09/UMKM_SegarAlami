...
<x-app-layout>
    <div class="max-w-4xl py-6 mx-auto">
        <h1 class="mb-4 text-2xl font-bold">Tambah News</h1>
    ...
    @endif
        ...
        <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium">Isi News</label>
                <textarea name="isi_news" id="editor" rows="5" class="block w-full mt-1 border-gray-300 rounded-md"></textarea>
            </div>
            <div class="mb-4">
