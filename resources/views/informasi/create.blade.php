...
<x-app-layout>
    <div class="max-w-4xl py-6 mx-auto">
        <h1 class="mb-4 text-2xl font-bold">Tambah informasi</h1>
    ...
    @endif
        ...
        <form action="{{ route('informasi.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium">Isi informasi</label>
                <textarea name="isi_informasi" id="editor" rows="5" class="block w-full mt-1 border-gray-300 rounded-md"></textarea>
            </div>
            <div class="mb-4">
