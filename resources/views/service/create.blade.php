    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('service.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <!-- Gambar Deskripsi -->
                <div class="mb-3">
                    <label for="gambar_deskripsi" class="form-label">Deskripsi Gambar</label>
                    <input type="file" name="gambar_deskripsi" id="gambar_deskripsi" class="form-control" accept="image/*" required>
                </div>

                <!-- Gambar Service -->
                <div class="mb-3">
                    <label for="gambar" class="form-label">Gambar Service</label>
...
<x-app-layout>
    <div class="max-w-4xl py-6 mx-auto">
        <h1 class="mb-4 text-2xl font-bold">Tambah Service</h1>
    ...
    @endif
        ...
        <form action="{{ route('service.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium">Deskripsi Gambar</label>
                <input type="file" name="gambar_deskripsi" class="block w-full mt-1" accept="gambar/*" />
            </div>
            <div class="mb-4">
